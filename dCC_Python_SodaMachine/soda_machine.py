...
class SodaMachine:
    ...
    def fill_inventory(self):
        ...
        #  Missing import: from dCC_Python_SodaMachine import cans
        for index in range(10):
    ...
    #  Missing colon: Every function or method should have a colon at the end of the header
    #  i.e. def gather_change_from_register(self, change_value)
    #  If the method in the example did not have a colon at the end, then ethere would be
    #  a SyntaxError.
    ...
    def calculate_coin_value(self, coin_list):
        ...
        #  Missing instantiation: total_value was not instantiated.
        total_value = 0
    ...
    #  Missing parameter: self was not the first parameter in the parameter list
    ...
    def deposit_coins_into_register(self, coin_list):
        ...
        #  Misspelling: coin_list parameter used in for loop was originally coins_list.
        #  Changed to coin_list to allow the parameter to actually be used.
        for coin in coin_list:
